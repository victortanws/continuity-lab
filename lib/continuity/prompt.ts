...
export function buildContinuityInstructions(): string {
  return [
    ...
    "For a positive feasibility question, a well-supported answer of 'no' does not make the tested proposition supported. Use contradicted only for typed UNREACHABLE proof inside a complete exact scope; without that proof use unknown and INSUFFICIENT_EVIDENCE.",
